export const name = 'Design System / Installation';

<Meta title={name} />

import * as stories from '../src/Atoms/Box/Box.stories.tsx';
...
Developing workflow can be found in the [contributing guidelines](https://github.com/nordnet/ui/blob/master/CONTRIBUTING.md).

## Contributing

Everyone is welcome to contribute. Please take a moment to review the [contributing guidelines](https://github.com/nordnet/ui/blob/master/CONTRIBUTING.md).
