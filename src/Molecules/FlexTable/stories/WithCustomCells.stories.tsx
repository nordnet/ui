      ...
      <FlexTable.Header.SortButton onClick={onSortClick}>
        <StyledFlexboxContainer container>
          <FlexTable.CellInlineContainer item>
            <FlexTable.Header.TextWrapper sorted={sorted}>{children}</FlexTable.Header.TextWrapper>
