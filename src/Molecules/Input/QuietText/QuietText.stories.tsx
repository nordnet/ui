...
export const WithValueControlledBehaviour = {
  render: () => (
    <Input.QuietText label="Label" placeholder="Placeholder" value="Some predefined text" />
  ),
...
export const WithDefaultValueUncontrolledBehaviour = {
  render: () => (
    <Input.QuietText label="Label" placeholder="Placeholder" defaultValue="Some predefined text" />
  ),
...
export const DisabledStory = {
  render: () => <Input.QuietText label="Label" placeholder="Placeholder" disabled />,
  name: 'Disabled',
};
...
export const WithAutoFocus = {
  render: () => <Input.QuietText label="Label" placeholder="Placeholder" autoFocus />,
...
export const WithAutoComplete = {
  render: () => (
    <>
      <Input.QuietText label="Ordinary Text" placeholder="Placeholder" autoComplete="on" />
      <Input.QuietText label="E-mail" placeholder="Placeholder" autoComplete="email" type="email" />
      <Input.QuietText
        label="Phone number"
        placeholder="Placeholder"
        autoComplete="tel"
...
export const RequiredStory = {
  render: () => (
    <Display
      ...
      items={[
        {
          component: <Input.QuietText label="Label" placeholder="Placeholder" required />,
...
export const ActionsStory = {
  render: () => (
    <>
      ...
      <Input.QuietText label="Label" placeholder="Placeholder" {...handlers} />
    </>
  ),
...
export const ExtraInfoBelow = {
  render: () => (
    <Input.QuietText label="Label" placeholder="Placeholder" extraInfo="Use this space wisely" />
  ),
...
export const FullWidthStory = {
  render: () => (
    <Display
      ...
      items={[
        {
          component: <Input.QuietText label="Label" width="100%" placeholder="Placeholder" />,
          title: 'Default',
        },
        {
          component: (
...
export const HiddenLabel = {
  render: () => <Input.QuietText label="Label" placeholder="Placeholder" hideLabel />,
  name: 'Hidden label',
};
...
export const Small = () => (
  <Display
    ...
    items={[
      {
        component: <Input.QuietText label="Label" size="s" placeholder="Placeholder" />,
        title: 'Default',
      },
      {
        component: (
          <Input.QuietText label="Label" size="s" width="100%" placeholder="Placeholder" />
        ),
        title: 'Full width',
      },
      {
      ...
      {
        component: (
          <Input.QuietText label="Label" size="s" placeholder="Placeholder" rightAddon="SEK" />
        ),
        title: 'Right addon',
      },
    ]}
...
export const Quiet = () => (
  <Display
    ...
    items={[
      {
        component: <Input.QuietText label="Label" placeholder="Placeholder" />,
        title: 'Default',
      },
      {
        component: <Input.QuietText label="Label" placeholder="Placeholder" value="Fill State" />,
        title: 'Filled',
      },
      {
        component: <Input.QuietText label="Label" width="100%" placeholder="Placeholder" />,
      ...
      {
        component: <Input.QuietText label="Label" width="100%" disabled value="0" />,
        title: 'Disabled',
      },
      {
        component: (
      ...
      {
        component: <Input.QuietText label="Label" placeholder="Placeholder" success />,
        title: 'Success',
      },

      {
        component: <Input.QuietText label="Label" placeholder="Placeholder" rightAddon="%" />,
        title: 'Right addon',
      },
      {
        component: <Input.QuietText label="Label" placeholder="Placeholder" leftAddon="$" />,
        title: 'Left addon',
      },
      {
        component: (
          <Input.QuietText label="Label" placeholder="Placeholder" leftAddon="$" rightAddon="%" />
        ),
        title: 'Both addon',
      },
    ]}
...
export const WithLabelTooltip = {
  render: () => (
    <Input.QuietText label="Label" labelTooltip="Tooltip content" placeholder="Placeholder" />
  ),
...
export const WithMaxLength = {
  render: () => <Input.QuietText maxLength={3} label="has max length" placeholder="Placeholder" />,
...
export const AlternatingTypes = () => (
  ...
  >
    <div>
      <Input.QuietText label="email" type="email" />
    </div>
    <div>
      <Input.QuietText label="password" type="password" />
    </div>
    <div>
      <Input.QuietText label="search" type="search" />
    </div>
    <div>
      <Input.QuietText label="search" type="submit" />
    </div>
  </form>
);
...
export const OnAColouredBackground = {
  render: () => (
    <Box p={5} backgroundColor={(t) => t.color.disabledBackground}>
      <Input.QuietText label="On a colored background" placeholder="Placeholder" />
    </Box>
  ),
