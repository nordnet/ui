...
import { Props, PropsWithFullscreen, PropsWithoutFullscreen } from './DateRangePicker.types';
...
import { getDateFormat, getLocale, newDate, parseDateStrings } from '../shared/dateUtils';
...
const DateRangePicker = React.forwardRef<HTMLDivElement, Props>((props, ref) => {
  ...
  }, [dateFormat, inputValueProp, options, selectedDateProp, selectedEndDateProp]);
  ...
  const onDateClick = useCallback(
    ...
    [viewedDate, handleDateClickRange, setFocused],
  );
  ...
  const handleInputOnChange = useCallback(
    (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (allowDateUpdateOnType) handleInputSubmitRange(value);
      setInputValue(value);
    },
    [handleInputSubmitRange, allowDateUpdateOnType],
  );
