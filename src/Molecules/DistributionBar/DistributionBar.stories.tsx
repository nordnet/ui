    ...
    <>
      <Flexbox container gap={3} direction="column">
          ...
          {instrumentList.map((item) => {
            return (
              <DistributionBar
                ...
                avatar={item.country ? <Flag size="m" country={item.country} /> : undefined}
              >
        ...
        <Flexbox item>
          ...
          <DistributionBar label="Label" weight={10} avatar={<Icon.Global16 />}></DistributionBar>
        </Flexbox>
