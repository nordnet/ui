...
Use this Grid component when you need a one-dimensional layout model that handles either columns or rows.

# Grid based on CSS Grid

Use this Grid component when you need a two-dimensional layout model that handles both columns and rows at the same time.
...
Think of this as visually writing down where you would like your grid items to be placed out and over how many columns they should span.
...
![alt text](https://css-tricks.com/wp-content/uploads/2018/11/dddgrid-template-areas.svg 'Logo Title Text 1')
